...
without authentication or authorization. See [SECURITY.md](/docs/security)
and [PRIVACY.md](/docs/privacy).

## Where can I ask for help?

See [SUPPORT.md](/docs/support) for the correct channel and diagnostic
